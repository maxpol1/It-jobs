                ...
                <div class="col-lg-12">
                    <div class="p-4 mb-8 bg-white">
                        <div class="company-desc">
                            ...
                            <h1>{{$company->cname}}</h1>
                            <p>Слоган-{{$company->slogan}}&nbsp;Address-{{$company->address}}&nbsp;
                                Телефон-{{$company->phone}}&nbsp; Website-{{$company->website}}</p>
                        </div>
                    </div>
                    <table class="table">
                        <tbody>
                        @foreach($company->jobs as $job)
                            <tr>
                                ...
                                <td>Позиция компании:{{$job->position}}
                                    <br>
                                ...
                                <td>
                                    <a href="{{route('jobs.show',[$job->slug])}}">
                                        <button class="btn btn-success btn-sm">Смотреть
                                        </button>
                                    </a>
                                </td>
                            </tr>
